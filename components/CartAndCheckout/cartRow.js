    ...
    return(
        <tr className="border-t border-b border-table">
                                        ...
                                        <td className="border-b border-table py-4 px-4 font-medium">
                                            ...
                                            {/* AttributsPhoneSized */}
                                            <div className="attributes my-4 flex flex-col md:hidden">
                                                <div className="attrColor items-center grid grid-cols-2 w-full mb-2">
                                                        <span className="uppercase text-11px inline-block ">Color</span>
                                                        <div className="ml-4  inline-block align-middle">
                                                        <div className="bg-clip-content phone:bg-cover phone:p-0 phone:border-0 bg-blue-600 p-1 border border-black w-30px h-30px phone:w-4 phone:h-4"></div>
                                                        </div>
                                                    </div>
                                                    <div className="attrSize items-center grid grid-cols-2 w-full mb-2">
                                                    ...
                                                    <div className="inline-flex  justify-center">
                                                        <button className="flex hover:bg-gray-400 text-black text-lg font-bold py-2 px-2 rounded-l items-center">
                                                            <MinusOutlined />
                                                        </button>
                                                        <input className="w-1/2 border text-center py-1 px-1"/>
                                                        <button className="flex hover:bg-gray-400 text-black text-lg font-bold py-2 px-2 rounded-r items-center">
                                                            <PlusOutlined/>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="attributes py-8 grid grid-cols-5 items-center phone:hidden">
                                                ...
                                                <div className="Quantity items-center col-span-2">
                                                    <div className="inline-flex  justify-center px-8">
                                                        <button className="flex hover:bg-gray-400 text-black text-lg font-bold py-2 px-3 rounded-l items-center">
                                                            <MinusOutlined />
                                                        </button>
                                                        <input className="w-1/2 border py-1 px-1"/>
                                                        <button className="flex hover:bg-gray-400 text-black text-lg font-bold py-2 px-3 rounded-r items-center">
                                                            <PlusOutlined/>
                                                        </button>
                                                    </div>
                                                </div>
                                                <div className="Del-btn items-center col-span-1 flex justify-end pr-4">
                                                    <button className="flex hover:bg-gray-400 py-1 px-1 rounded-l items-center">
