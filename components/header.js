    ...
    return(
        <header className="shadow-lg phone:mb-2">
          <nav className="flex items-center justify-between flex-wrap phone:px-4">
           <div className="w-full bg-bateeq-topheader phone:hidden tablet:hidden">
            <div className="container mx-auto grid lg:grid-cols-4 lg:items-center  py-4">
        ...
        <div id="language-selector" className="justify-center w-full block flex-grow lg:flex lg:items-center lg:w-1/4 phone:mb-4">
        ...
        <div id="logo" className="w-1/2 phone:inline-block flex-col lg:flex lg:items-center lg:w-1/2">
                <Link href="/">  
                    <a className="w-auto ">
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-1/4 text-base">
          <div className="text-base lg:flex-grow text-center">
            <div className=" block mt-4 lg:inline-block lg:mt-0 mr-5 align-middle phone:mr-0">        
                <input type="search" className="bg-transparent focus:outline-none py-1 px-2 inline w-24 align-top phone:w-5/6" placeholder="SEARCH" />
        ...
        <div id="header-menu" className=" w-full block lg:items-center pr-16 pl-16 pt-4 pb-4 phone:hidden">
            <ul className="block text-center text-base uppercase">
                <li className="mr-16 ml-16 inline-block">
