    ...
    return(
        <header className="shadow-lg">
          <nav class="flex items-center justify-between flex-wrap ">
           <div className="w-full bg-bateeq-topheader ">
            <div class="container mx-auto grid lg:grid-cols-4 lg:items-center  py-4">
           
                <div id="language-selector" className="col-span-1 text-center">
        ...
        <div id="lower-header" className="container mx-auto my-16 w-full block flex-grow lg:flex lg:items-center ">
        <div id="language-selector" className="justify-center w-full block flex-grow lg:flex lg:items-center  lg:w-1/4 ">
        ...
        <div id="logo" className="w-full block flex-grow flex-col lg:flex lg:items-center lg:w-1/2">
                <Link href="/">  
                    <a className="w-auto ">
        ...
        <div class="w-full block flex-grow lg:flex lg:items-center lg:w-1/4 text-base">
          <div class="text-base lg:flex-grow text-center">
            <div className=" block mt-4 lg:inline-block lg:mt-0 mr-5 align-middle">        
                <input type="search" className="bg-transparent focus:outline-none py-1 px-2 inline w-24 align-top" placeholder="SEARCH" />
            ...
            <div className="block mt-4 lg:inline-block lg:mt-0 mr-6 text-base">
                <a href="#responsive-header">
                    <svg className="block lg:inline-block lg:mt-0 align-middle" width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="block mt-4 lg:inline-block lg:mt-0 mr-6 text-base">
                    <a href="#responsive-header" >
                        <svg className="block lg:inline-block lg:mt-0 "  width="13" height="15" viewBox="0 0 13 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="block mt-4 lg:inline-block lg:mt-0 mr-6 text-base">
                    <a href="#responsive-header">
                    <svg className="block  lg:inline-block lg:mt-0 " width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="header-menu" className=" w-full block lg:items-center pr-16 pl-16 pt-4 pb-4">
            <ul class="block text-center text-base uppercase">
                <li class="mr-16 ml-16 inline-block">
                    <a class="text-black hover:text-blue-800" href="#">New Arrival</a>
                </li>
                <li class="mr-16 ml-16 inline-block">
                    <a class="text-black hover:text-blue-800" href="#">Women</a>
                </li>
                <li class="mr-16 ml-16 inline-block">
                    <a class="text-black hover:text-blue-800" href="#">Men</a>
                </li>
                <li class="mr-16 ml-16 inline-block">
                    <a class="text-black cursor-not-allowed" href="#">Kids</a>
                </li>
                <li class="mr-16 ml-16 inline-block">
                    <a class="text-black cursor-not-allowed" href="#">Home Living</a>
                </li>
                <li class="mr-16 ml-16 inline-block">
                    <a class="text-black cursor-not-allowed" href="#">Sale</a>
                </li>
             </ul>
        </div>
      </nav>
